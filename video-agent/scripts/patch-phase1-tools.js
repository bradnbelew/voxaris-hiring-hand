#!/usr/bin/env node
/**
 * Phase 1 persona patch — pushes the updated tool definitions to Jordan
 * (staffing) via JSON Patch.
 *
 ...
 *
 * The persona already has the correct `type: "function"` wrapper format
